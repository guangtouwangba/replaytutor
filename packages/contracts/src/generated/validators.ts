...
const schemas = {
  ...
  "CompanionBootstrapParams": {
    ...
    "title": "CompanionBootstrapParams",
    "type": "object"
  },
  "CompanionBootstrapResult": {
    ...
    "title": "CompanionBootstrapResult",
    "type": "object"
  },
  "CompanionEmptyParams": {
    "additionalProperties": false,
    "properties": {},
    "title": "CompanionEmptyParams",
    "type": "object"
  },
  "CompanionError": {
    "additionalProperties": false,
  ...
  "CompanionNavigationParams": {
    ...
    "title": "CompanionNavigationParams",
    "type": "object"
  },
  "CompanionNavigationTarget": {
    ...
    "properties": {
      "path": {
        "pattern": "^/sessions/[a-z]{3}_[0-9a-f-]{36}",
        "title": "Path",
        "type": "string"
      },
      "schema_version": {
    ...
    "title": "CompanionNavigationTarget",
    "type": "object"
  },
  "CompanionRequest": {
    "additionalProperties": false,
  ...
  "CompanionSessionListParams": {
    ...
    "title": "CompanionSessionListParams",
    "type": "object"
  },
  "CompanionSessionListResult": {
    ...
    "properties": {
      ...
      "sessions": {
        "items": {
          "$ref": "#/$defs/CompanionSessionSummary"
        },
        "maxItems": 50,
        "title": "Sessions",
        "type": "array"
    ...
    "title": "CompanionSessionListResult",
    "type": "object"
  },
  ...
  "CompanionSessionStateResult": {
    ...
    "title": "CompanionSessionStateResult",
    "type": "object"
  },
  "CompanionSessionSummary": {
    "$defs": {
  ...
  "CompanionThreadCreateParams": {
    ...
    "properties": {
      "request": {
        "$ref": "#/$defs/CreateTutorThreadRequest"
      },
      "session_id": {
        "pattern": "^[a-z]{3}_[0-9a-f-]{36}$",
        "title": "Session Id",
    ...
    "title": "CompanionThreadCreateParams",
    "type": "object"
  },
  "CompanionThreadListParams": {
    ...
    "title": "CompanionThreadListParams",
    "type": "object"
  },
  ...
  "IndicatorEvidence": {
    ...
    "properties": {
      ...
      "points": {
        "items": {
          "$ref": "#/$defs/IndicatorEvidencePoint"
        },
        "maxItems": 50,
        "title": "Points",
        "type": "array"
  ...
  "MarketDepthImportRequest": {
    ...
    "properties": {
      "asks": {
        "items": {
          "$ref": "#/$defs/MarketDepthInputLevel"
        },
        "maxItems": 5000,
        "minItems": 1,
        "title": "Asks",
    ...
    "title": "MarketDepthImportRequest",
    "type": "object"
  },
  "MarketDepthInputLevel": {
    "additionalProperties": false,
    ...
    "properties": {
      ...
      "reason": {
        "anyOf": [
          {
            "enum": [
              "historical_depth_not_captured",
              "depth_snapshot_is_stale"
            ],
            "type": "string"
          },
          {
