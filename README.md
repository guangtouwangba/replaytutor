...
> 当前阶段：MVP 1A 的 BTCUSDT 核心纵向闭环已落地，包括 Snapshot、逐 K 回放、计划门禁、模拟订单、Decimal 账本、趋势线/矩形/标记、AI 标注处置、证据回跳、确定性复盘、Playbook、Codex Tutor 和隔离浏览器 E2E。Playbook 确定性规则检查仍待封板。Binance U 本位只读成交复盘作为独立切片保留。本项目不提供任何真实下单能力。
