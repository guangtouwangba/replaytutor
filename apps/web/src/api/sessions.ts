...
export async function fetchSessions(): Promise<SessionListResponse> {
  return contractJson(
    await apiFetch(`${API_BASE_URL}/api/v1/sessions`),
    "SessionListResponse",
  );
}
...
export async function fetchSessionTrash(): Promise<SessionTrashResponse> {
  return contractJson(
    await apiFetch(`${API_BASE_URL}/api/v1/sessions-trash`),
    "SessionTrashResponse",
  );
}
...
export async function deleteSession(sessionId: string): Promise<ReplaySession> {
  return contractJson(
    await apiFetch(`${API_BASE_URL}/api/v1/sessions/${sessionId}`, {
      method: "DELETE",
    }),
    "ReplaySession",
  );
...
export async function restoreSession(sessionId: string): Promise<ReplaySession> {
  return contractJson(
    await apiFetch(`${API_BASE_URL}/api/v1/sessions/${sessionId}/restore`, {
      method: "POST",
    }),
    "ReplaySession",
  );
...
export async function applySessionCommand(
  ...
  return contractJson(
    await apiFetch(`${API_BASE_URL}/api/v1/sessions/${sessionId}/commands`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(payload),
    }),
...
export async function finishSession(
  ...
  return contractJson(
    await apiFetch(`${API_BASE_URL}/api/v1/sessions/${sessionId}/finish`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(payload),
    }),
...
export async function lockTradePlan(
  ...
  return contractJson(
    await apiFetch(`${API_BASE_URL}/api/v1/sessions/${sessionId}/plan`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(payload),
    }),
...
export async function submitOrder(
  ...
  return contractJson(
    await apiFetch(`${API_BASE_URL}/api/v1/sessions/${sessionId}/orders`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(payload),
    }),
...
export async function cancelOrder(
  ...
  return contractJson(
    await apiFetch(`${API_BASE_URL}/api/v1/sessions/${sessionId}/orders/cancel`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(payload),
    }),
...
export async function amendOrder(
  ...
  return contractJson(
    await apiFetch(`${API_BASE_URL}/api/v1/sessions/${sessionId}/orders/amend`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(payload),
    }),
...
export async function createAnnotation(
  ...
  return contractJson(
    await apiFetch(`${API_BASE_URL}/api/v1/sessions/${sessionId}/annotations`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(payload),
    }),
...
export async function fetchTrainingReview(
  ...
  return contractJson(
    await apiFetch(`${API_BASE_URL}/api/v1/sessions/${sessionId}/review`),
    "TrainingReview",
  );
}
...
export async function fetchPlaybookEvaluation(
  ...
  return contractJson(
    await apiFetch(`${API_BASE_URL}/api/v1/sessions/${sessionId}/playbook-checks`),
    "PlaybookEvaluation",
  );
}
...
export async function fetchTrainingReviews(): Promise<TrainingReviewListResponse> {
  return contractJson(
    await apiFetch(`${API_BASE_URL}/api/v1/training-reviews`),
    "TrainingReviewListResponse",
  );
}
