...
const resources = {
  ...
  "zh-CN": { translation: {
    ...
    "setup.instrumentData": "品种与行情", "setup.trainingInstrument": "训练品种", "setup.marketType": "市场类型", "setup.usdtPerpetual": "U 本位永续", "setup.spot": "现货", "setup.historyRange": "自动补数范围", "setup.default30": "仅在本地无可用数据时使用", "setup.range30": "30 天", "setup.range365": "1 年", "setup.bars30": "约 43,200 根", "setup.bars365": "约 525,600 根", "setup.checkingLocal": "正在检查本地数据", "setup.readingIndex": "读取 Snapshot 索引与质量状态…", "setup.localError": "无法读取本地行情：{{message}}", "setup.localHit": "已选择本地数据", "setup.localCoverage": "{{count}} 根 1m K 线 · {{start}} 至 {{end}}", "setup.snapshotVersion": "Snapshot 版本", "setup.snapshotCreated": "创建于 {{date}}", "setup.snapshotNoCoverage": "选择已有版本，或下载所需范围", "setup.downloading": "行情正在后台下载", "setup.localMissing": "本地暂无满足范围的行情", "setup.downloadingHint": "当前 {{progress}}%，可以切换到其他页面，完成后再回来开始训练。", "setup.downloadHint": "点击后在后台下载 Binance 最近 {{range}}完整 1m K 线；不需要 API Key。",
