...
export function AnnotationInspector({
  ...
  if (!disposition) {
    return <div className="dock-card annotation-inspector"><span className="page-kicker">ANNOTATION INSPECTOR</span><p>{english ? "Select an annotation from Layer Objects to inspect it." : "在图层列表中选择一条标注进行检查。"}</p></div>;
  }
